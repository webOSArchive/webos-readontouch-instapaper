enyo.kind({
    ...
    width: (Util.isTouchpad() || Util.isWebOS() == false ? "450px" : "320px"), 
    height: (Util.isTouchpad() || Util.isWebOS() == false ? "480px" : "370px"),
    events: {
        onAccept: ""
    },
    components: [
        ...
        {kind: enyo.Scroller, flex: 1, height: (Util.isTouchpad() || Util.isWebOS() == false ? "360px" : "260px"), autoVertical: false, horizontal: false, components: [
